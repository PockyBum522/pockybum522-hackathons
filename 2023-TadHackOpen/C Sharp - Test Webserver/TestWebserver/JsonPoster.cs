...
{
    public async Task<HttpResponseMessage> PostJsonAsync(string rawJson)
    {
        ...
        var response = await httpClient.PostAsync("https://apigateway.engagedigital.ai/api/v1/accounts/AC-e815a968-966e-4387-a175-b62ebd6ce36a/call", content);
