...
public class SpeechRecognizer
{
    ...
    public static async Task StartSpeechRecognitionLoop()
    {
        ...
        while (true)
        {
            ...
            if (newWordsLine.StartsWith("text: ") && !hasRecognitionStarted)
            {
                ...
                ShowPromptToSpeak(fullSpokenWords);
            } 
    ...
    private static void ShowPromptToSpeak(string fullSpokenWords)
    {
        Console.Clear();
        Console.WriteLine();
        Console.WriteLine($"Coin has been placed on the altar. Please speak now.");
        Console.WriteLine();
        Console.WriteLine("It is tradition to offer your hopes, fears, and dreams at the temple when you offer your coin.");
        Console.WriteLine();
        Console.WriteLine();
